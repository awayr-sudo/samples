...
<div class="p-mt-3 p-ml-3">
  ...
  <Button label="Add a Reminder..." icon="pi pi-plus" name="Customer[Category]" v-model="category" class=" p-button-link" @click="addNotepad"/>  

   <Dialog v-model:visible="displayNotepad" :style="{width: '50vw'}">
      <template #header>
      <label class="gem-main-hiding">
        <i class="pi pi-file p-mr-2" style="fontSize: 1rem"></i>
        <span class="dormer-heading " >Adding a Notepad</span>  
      </label>
      </template>
           <Splitter class="spliter">
      <SplitterPanel :size="15" :minSize="10">
        <img src="../../../assets/logs/notepad.png" style="height: 132px" class="p-ml-3" />
  ...
  <div class="p-fluid p-mx-2 p-ml-3">
    <div class="p-grid">
      <span class="p-col-6 p-d-flex p-ai-center">
        <i class="pi pi-pencil"></i>
        <label class="p-ml-2 p-text-bold">Name</label>
      </span>
      <span class="p-col-6">
